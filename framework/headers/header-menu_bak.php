...
<div class='top-menu'>
	<ul id="snav" class="menu">
			...
			<div class="login-box">
				...
				<form action="<?php echo wp_login_url(); ?>" name="loginform" method="post">
					...
					<p class="forgetmenot">
						...
						<p class="submit">
						<input type="submit" name="wp-submit" id="wp-submit" class="aione-button button-default button-small button small default comment-submit" value="<?php _e('Log In', 'Aione'); ?>">
		...
		<li class="cart">
			...
			<a class="empty-cart" href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>"><span><?php _e('Cart', 'Aione'); ?></span></a>
			<?php else: ?>
	...
	<?php if(tf_checkIfMenuIsSetByLocation('top_navigation')  && $theme_options['mobile_menu_design'] == 'classic'): ?>
