 ...
 */
function aione_get_adjacent_post_plus($r, $previous = true ) {
	global $post, $wpdb;
 ...
 */
function aione_previous_post_link_plus($args = '') {
	return aione_adjacent_post_link_plus($args, '&laquo; %link', true);
}
 ...
 */
function aione_next_post_link_plus($args = '') {
	return aione_adjacent_post_link_plus($args, '%link &raquo;', false);
}
 ...
 */
function aione_adjacent_post_link_plus($args = '', $format = '%link &raquo;', $previous = true) {
	$defaults = array(
...
//	If Post Types Order plugin is installed, default to sorting on menu_order
	...
	if ( $previous && is_attachment() ) {
		...
		$posts = aione_get_adjacent_post_plus($r, $previous);
