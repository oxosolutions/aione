...
export class OldTabHolder extends Component {
	...
	render() {
		...
		const addTab = (i) => {
			insertBlock(createBlock("aione-blocks/aione-tab", {}), i, this.props.block.clientId);
		...
		return [
			...
			<div className={className}>
				...
				<div className={`${className}-holder aione-tabs ${direction}`}>
					<block.SortableList
						axis="x"
						propz={this.props}
					...
					<div className={`${className}-tabs-content content`}>
						<InnerBlocks templateLock={false} allowedBlocks={["aione-blocks/aione-tab"]} />
					</div>
				</div>
			</div>,
		];
...
export class TabHolder extends Component {
	...
	render() {
		...
		let className = "wp-block-aione-tabs-content";
		...
		const addTab = (i) => {
			insertBlock(
				createBlock("aione-blocks/aione-tab-block", {}),
				i,
				this.props.block.clientId
			);
			setAttributes({
		...
		return [
			...
			>
				...
				>
					<div
						className={`${className}-tab-holder nav ${
