...
function ub_handleTabEvent(tab) {
  var parent = tab.closest(".wp-block-aione-tabs-content-holder");
  var isVertical = parent.classList.contains("vertical-holder");
  var activeStyle = parent.querySelector(".wp-block-aione-tabs-content-tab-title-".concat(isVertical ? "vertical-" : "", "wrap.active")).getAttribute("style");
  var defaultStyle = parent.querySelector(".wp-block-aione-tabs-content-tab-title-".concat(isVertical ? "vertical-" : "", "wrap:not(.active)")).getAttribute("style");
  ub_getSiblings(tab, function (elem) {
    return elem.classList.contains("wp-block-aione-tabs-content-tab-title-".concat(isVertical ? "vertical-" : "", "wrap"));
  ...
  var tabContentContainer = Array.prototype.slice.call(parent.children).filter(function (elem) {
    return elem.classList.contains("wp-block-aione-tabs-content-tabs-content");
  })[0];
  Array.prototype.slice.call(tabContentContainer.children).filter(function (child) {
    return child.classList.contains("wp-block-aione-tabs-content-tab-content-wrap");
  ...
  Array.prototype.slice.call(tabContentContainer.children).filter(function (child) {
    return child.classList.contains("wp-block-aione-tabs-content-accordion-toggle");
...
Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content-tab-title-wrap")).forEach(function (instance) {
...
Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content-tab-title-vertical-wrap")).forEach(function (instance) {
  instance.addEventListener("focus", function () {
    ub_handleTabEvent(instance);
  });
});
...
function ub_getTabbedContentDisplayModes(block) {
  var dm = [];
  var classNamePrefix = "wp-block-aione-tabs-content";
...
(function () {
  var displayModes = Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content")).map(function (block) {
  ...
  function processTransition() {
    if (transitionTo && transitionFrom) {
      Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content")).forEach(function (instance, i) {
  ...
  if (targetElement) {
    if (targetElement.classList.contains("".concat(classNamePrefix, "-tab-content-wrap"))) {
      ...
      var findTabContentRoot = function findTabContentRoot(currentBlock) {
        var parentTabbedContent = currentBlock.closest(".wp-block-aione-tabs-content-tabs-content");

        if (parentTabbedContent) {
          ancestorTabIndexes.push(Array.prototype.slice.call(parentTabbedContent.children).filter(function (t) {
            return t.classList.contains("wp-block-aione-tabs-content-tab-content-wrap");
          }).indexOf(currentBlock.closest(".wp-block-aione-tabs-content-tab-content-wrap")));
...
document.addEventListener("DOMContentLoaded", function () {
  Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content")).forEach(function (instance) {
    var tabBar = instance.children[0].children[0];
...
Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content-tabs-content")).forEach(function (container) {
...
Array.prototype.slice.call(document.getElementsByClassName("wp-block-aione-tabs-content-tab-holder")).forEach(function (tabBar) {
  var tabBarIsBeingDragged = false;
  var oldScrollPosition = -1;
  var oldMousePosition = -1;
  var tabBarLocation = tabBar.getBoundingClientRect().x || tabBar.getBoundingClientRect().left;
