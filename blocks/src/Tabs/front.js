...
function ub_handleTabEvent(tab) {
	const parent = tab.closest(".wp-block-aione-tabs-content-holder");

	const isVertical = parent.classList.contains("vertical-holder");

	const activeStyle = parent
		.querySelector(
			`.wp-block-aione-tabs-content-tab-title-${
				isVertical ? "vertical-" : ""
			}wrap.active`
		)
		.getAttribute("style");
	...
	const tabContentContainer = Array.prototype.slice
		...
		.filter((elem) =>
			elem.classList.contains("wp-block-aione-tabs-content-tabs-content")
		)[0];

	Array.prototype.slice
		.call(tabContentContainer.children)
		.filter((child) =>
			child.classList.contains("wp-block-aione-tabs-content-tab-content-wrap")
		)
	...
	Array.prototype.slice
		.call(tabContentContainer.children)
		.filter((child) =>
			child.classList.contains("wp-block-aione-tabs-content-accordion-toggle")
		)
...
Array.prototype.slice
	.call(
		document.getElementsByClassName("wp-block-aione-tabs-content-tab-title-wrap")
	)
	.forEach((instance) => {
...
Array.prototype.slice
	.call(
		document.getElementsByClassName(
			"wp-block-aione-tabs-content-tab-title-vertical-wrap"
		)
	)
	.forEach((instance) => {
		instance.addEventListener("focus", function () {
...
function ub_getTabbedContentDisplayModes(block) {
	let dm = [];
	const classNamePrefix = "wp-block-aione-tabs-content";
...
(function () {
	const displayModes = Array.prototype.slice
		.call(document.getElementsByClassName("wp-block-aione-tabs-content"))
		...
		if (
			...
			const findTabContentRoot = (currentBlock) => {
				const parentTabbedContent = currentBlock.closest(
					".wp-block-aione-tabs-content-tabs-content"
				);
						...
						Array.prototype.slice
							...
							.filter((t) =>
								t.classList.contains(
									"wp-block-aione-tabs-content-tab-content-wrap"
								)
							)
							.indexOf(
...
Array.prototype.slice
	.call(
		document.getElementsByClassName("wp-block-aione-tabs-content-tabs-content")
	)
	.forEach((container) => {
		Array.prototype.slice
...
Array.prototype.slice
	.call(
		document.getElementsByClassName("wp-block-aione-tabs-content-tab-holder")
	)
	.forEach((tabBar) => {
		let tabBarIsBeingDragged = false;
		let oldScrollPosition = -1;
