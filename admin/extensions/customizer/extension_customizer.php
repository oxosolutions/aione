            ...
            class Redux_customizer_switch extends WP_Customize_Control {
                ...
                public function render_content() {
                    ...
                    <span class="customize-control-title"><?php echo esc_html( $this->label ); ?>
                        <input type="checkbox"  style="float: right;margin-top:6px;" <?php $this->link(); ?> class="checkbox checkbox-input" id="header_show_sliding_bar" name="theme_options[header_show_sliding_bar]" <?php if( $this->value()){ echo 'checked="checked"';}?> value="<?php if( $this->value()){ echo "1";} else {echo "0";}?>">
                        </span>
                <?php
                }
            } // class
